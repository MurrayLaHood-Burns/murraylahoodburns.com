...
A rebuild of my [original website](https://github.com/MurrayLaHood-Burns/personal-website), built entirely in
JavaScript using [ReactJS](https://facebook.github.io/react). Using React may be overkill for the contents of
this website, but I enjoyed working with it. In writing my website in React, I have gained a greater understanding
of:

- use of functional and class components
- correctly using npm to find useful components
